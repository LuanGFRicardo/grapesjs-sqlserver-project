@extends('filament.pages.editor.layouts.app')
...
@section('content')
    <div id="gjs"></div>
    @include('filament.pages.editor.partials.modal-editor')
@endsection
...
@push('scripts')
    ...
    @include('filament.pages.editor.scripts.global-config')
    @include('filament.pages.editor.scripts.api-functions')
    @include('filament.pages.editor.scripts.html-utils')
    @include('filament.pages.editor.scripts.editor-init')
    @include('filament.pages.editor.scripts.code-editor')
    @include('filament.pages.editor.scripts.navigation')
@endpush